...
export { Rendering, VideoRendering, AudioRendering, RenderingQuality, Encoding, Role, DestinationAddress, VideoEncoding, AudioEncoding, VideoCodec, AudioCodec, VideoCodecRateControl, VideoCodecProfile, ProjectBroadcastPhase, };
export declare type SceneNode = Compositor.SceneNode;
/**
 * A **Project** provides
 * access to a unique WebRTC room for video conferencing, and contains
 * information about all elements of a stream configuration.
 ...
 * @category Devices
 */
export declare type Webcam = MediaDeviceInfo & {
    kind: 'videoinput';
};
/**
 * See MDN docs for more information on {@link https://developer.mozilla.org/en-US/docs/Web/API/MediaDeviceInfo **MediaDeviceInfo**}
 * @category Devices
 */
export declare type Microphone = MediaDeviceInfo & {
    kind: 'audioinput';
};
/**
 * See MDN docs for more information on {@link https://developer.mozilla.org/en-US/docs/Web/API/MediaDeviceInfo **MediaDeviceInfo**}
 * @category Devices
 */
export declare type Speakers = MediaDeviceInfo & {
    kind: 'audiooutput';
};
/**
 * @category Devices
...
export interface Room {
     ...
     */
    cb: (tracks: Track[]) => void) => Disposable;
    /**
     ...
     */
    cb: (media: Track) => void) => Disposable;
    /**
     ...
     */
    cb: (participants: Participant[]) => void) => Disposable;
    /**
     ...
     */
    cb: (data: any, senderId: string) => void) => void;
    /**
     ...
     */
    cb: (participant: Participant) => void) => Disposable;
    /**
     ...
     */
    cb: (chatHistory: ChatObject[]) => void) => Disposable;
}
/**
...
export declare type CompositorSettings = {
    projectId: string;
 ...
 * @category Core
 */
export declare type GuestOptions = {
    projectId?: string;
    displayName?: string;
    /**
     * Requested duration of token before it expires.
